  ...
  constructor(container) {
    ...
    _defineProperty(this, "init", async () => {
      ...
      await Promise.all(this.productHandles.map(async hdl => {
        ...
        const prodHTML = await (0,utilities_fetch.fetchCache)(url);
...
class Cart {
  constructor() {
    ...
    _defineProperty(this, "getCart", () => {
      return (0,utilities_fetch.fetchJSON)(this.rootUrl + 'cart.json');
    });

    _defineProperty(this, "changeCart", lineItem => {
      return (0,utilities_fetch.fetchJSON)(cart_MinimogSettings.routes.cart_change_url, {
        headers: {
          'Content-Type': 'application/json',
    ...
    _defineProperty(this, "updateCart", data => {
      return (0,utilities_fetch.fetchJSON)(cart_MinimogSettings.routes.cart_update_url, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Accept': `application/json`
        ...
        handler: (e, addonButton) => {
          ...
          function checkValidity(){
            ...
            if (occupationInput.value === '' || nameInput.value === '' || addressInput.value === '' || phoneInput.value === '' || doyInput.value === '') {
              showErrorMessage.textContent = 'Παρακαλώ συμπληρώστε όλα τα πεδία';
              valid = false;
            }
      ...
      if (this.domNodes.cartDiscountCode) {
        (0,events/* addEventDelegate */.X)({
          ...
          handler: (e, target) => {
            ...
            if (target?.dataset.action === 'invoice') {
              this.updateCartNote();
            }
...
const fetchProductByHandle = async handle => {
  ...
  const product = await (0,utilities_fetch.fetchJsonCache)(url).catch(console.error);
